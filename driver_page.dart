...
class _DriverMapPageState extends State<DriverMapPage> {
  ...
  Future<void> storeBusData(
      String busNumber, double latitude, double longitude) async {
    try {
      ...
      if (permissionGranted == PermissionStatus.granted) {
        _locationUpdateTimer =
          ...
          setState(() {
            ...
            storeBusData(_busNumberController.text, locationData.latitude!,
  ...
  void _recenterMap() {
    if (_currentLocation != null) {
      _mapController.move(
          _currentLocation!, 15.0); // Recenter the map to the current location
    } else {
      ScaffoldMessenger.of(context).showSnackBar(
